...
A high-performance WhatsApp Web library built on [Baileys](https://github.com/WhiskeySockets/Baileys), with critical paths accelerated via a [Rust WASM bridge](https://github.com/andhikagg/whatsapp-rust-bridge).

---

See [CHANGELOG.md](CHANGELOG.md) for the full version history.

> This is a merger between the two baileys [baron-baileys-v2](https://github.com/7ucg/baron-baileys-v2.git) and [itsliaaa-baileys](https://github.com/itsliaaa/baileys.git)
